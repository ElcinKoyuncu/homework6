...
var apiKey = '&appid=bd33dc13455cfd72c93aa9cbec90aadf';
...
$(document).ready(function () {
    ...
    function currentWeather() {
        var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + currentCity + "&units=imperial&appid=bd33dc13455cfd72c93aa9cbec90aadf";
        var queryURLCurrent = "https://api.openweathermap.org/data/2.5/weather?q=" + currentCity + "&units=imperial&appid=bd33dc13455cfd72c93aa9cbec90aadf";
        $.ajax({
            url: queryURLCurrent,
            method: "GET"
        ...
        var lat = response.coord.lat;
            ...
            var uvQueryURL = "https://api.openweathermap.org/data/2.5/uvi?appid=bd33dc13455cfd72c93aa9cbec90aadf&lat=" + lat + "&lon=" + lon;
